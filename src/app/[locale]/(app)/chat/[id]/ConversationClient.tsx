  ...
  return (
    <div className="flex flex-col h-[calc(100vh-56px)]">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-border bg-surface">
        <Link href="/chat" className="text-muted hover:text-text transition-colors">
        ...
        {otherUser ? (
          <>
            ...
            <Link
              ...
              className="font-semibold text-sm text-text hover:text-accent transition-colors"
            >
              {otherUser.username}
            </Link>
          </>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-3">
        {loading && (
          <div className="text-center text-sm text-muted py-8">...</div>
        )}
      ...
      >
        <input
          ...
          className="flex-1 bg-surface2 border border-border rounded-full px-4 py-2 text-sm text-text placeholder-muted focus:outline-none focus:ring-1 focus:ring-accent"
        />
        <button
          type="submit"
          disabled={!text.trim() || sending}
          className="w-9 h-9 rounded-full bg-accent text-white flex items-center justify-center hover:bg-accent-hover disabled:opacity-50 transition-colors flex-shrink-0"
          aria-label={t('send')}
        >
