...
> - **Logotipo e iconografía de marca: nunca genéricos.** Prohibido dejar el nombre "KULTURA" tipografiado sin más como si fuera el logo — tiene que ser una marca diseñada (icono/monograma propio con significado, tratamiento de letra propio), igual que el resto de iconografía de marca. Regla explícita del usuario (2026-09-11): "nadie tiene que tener la sensación de estar usando una aplicación hecha por IA" — aplica a todo el Bloque F, no solo al logo: evitar plantillas visualmente genéricas, gradientes/iconos de stock, y cualquier acabado que delate "hecho con IA sin criterio".
